...
INSERT INTO "new_pets" ("age", "energy_level", "environment", "id", "independence_level", "name", "size") SELECT "age", "energy_level", "environment", "id", "independence_level", "name", "size" FROM "pets";
DROP TABLE "pets";
